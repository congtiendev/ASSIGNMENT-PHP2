<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from demo.foxthemes.net/instellohtml/feed.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Jan 2023 10:18:39 GMT -->
<head>
    <meta charset="UTF-8"/>
...
<div id="wrapper">
    <div class="sidebar">
        ...
        >
            <a href="#">
                ...
                <img src="../images/logo-light.png" class="logo_inverse"/>
            </a>
            <!-- btn night mode -->
            <a
                    href="#"
        ...
        <div
                class="border-b border-gray-20 flex justify-between items-center p-3 pl-5 relative uk-hidden@s"
        >
    ...
    <div class="main_content">
            ...
            <div class="header_inner">
                ...
                <div class="right-side lg:pr-4">
                    ...
                    >
                        ...
                        <div
                                class="flex justify-center flex-center text-center dark:text-gray-300"
                        >
                            <div class="flex flex-col choose-upload text-center">
                                ...
                                <p class="my-3 leading-6">
                                    Do you have a video wants to share us <br/>
                                    please upload her ..
                                </p>
                                <div uk-form-custom>
                                    <input type="file"/>
                                    <a href="#" class="button soft-warning small">
                                        Choose file</a
                                    >
                                </div>
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <div class="drop_content">
                                        <p>
                                            <strong>Adrian Mohani</strong> Lorem ipsum dolor
                                            cursus
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <div class="drop_content">
                                        ...
                                        <time>12:43 PM</time>
                                        <p>
                                            Sediam nonummy nibh euismod tincidunt laoreet dolore
                                        </p>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <div class="drop_content">
                                        ...
                                        <time> Sun</time>
                                        <p>
                                            Namliber tempor cumsoluta nobis eleifend option
                                            adipiscing
                                        </p>
                                    </div>
                                </a>
        ...
        <div class="container m-auto">
            <h1
                    class="lg:text-2xl text-lg font-extrabold leading-none text-gray-900 tracking-tight mb-5"
            >
                Feed
            </h1>
                      ...
                      Johnson smith
                        ...
                        <div uk-lightbox>
                            <div class="grid grid-cols-2 gap-2 p-2">
                                <a href="../images/post/img9.jpg" class="col-span-2">
                                    <img
                                            src="../images/post/img9.jpg"
                                            alt=""
                                            class="rounded-md w-full lg:h-76 object-cover"
                                    />
                                </a>
                                <a href="../images/post/img10.jpg">
                                    <img
                                            src="../images/post/img10.jpg"
                                            alt=""
                                            class="rounded-md w-full h-full"
                                    />
                                </a>
                                <a href="../images/post/img11.jpg" class="relative">
                                    <img
                                            src="../images/post/img11.jpg"
                                            alt=""
                                            class="rounded-md w-full h-full"
                                    />
                                    <div
            ...
            <div class="story-content p-4" data-simplebar>
                ...
                <div class="py-4">
                    <div class="flex justify-around">
                        ...
                        <a href="#" class="flex items-center space-x-3">
                            <div class="flex font-bold items-baseline">
                                <i class="uil-heart mr-1"> </i> Share
                            </div>
                        </a>
                    </div>
                    <hr class="-mx-4 my-3"/>
                ...
                <div class="-mt-1 space-y-1">
                    ...
                    <div class="flex flex-1 items-center space-x-2">
                        <img
                                ...
                                class="rounded-full w-8 h-8"
                        />
                        <div class="flex-1 p-2">consectetuer adipiscing elit</div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from demo.foxthemes.net/instellohtml/feed.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Jan 2023 10:18:52 GMT -->
</html>
