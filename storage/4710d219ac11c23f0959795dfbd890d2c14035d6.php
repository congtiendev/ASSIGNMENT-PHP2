                    ...
                    <form class="w-full" action="./store-update-account?id=<?php echo e($user->user_id); ?>" method="post"
                        ...
                        <div class="grid grid-cols-2 gap-3 sm:gap-5 list__form-group">
                            <div class="flex flex-col form__group">
                                ...
                                <input value="<?php echo e($user->full_name); ?>" type="text" name="full_name" id="full_name"
                                    required
                            ...
                            <div class="flex flex-col form__group">
                                ...
                                <input value="<?php echo e($user->user_name); ?>" type="text" name="user_name" id="user_name"
                                    required
                                    class="creat-user__input p-2 mt-1 glassmorphism text-gray-100 outline-none focus:outline-none text-sm rounded-lg"
                            ...
                            <div class="flex flex-col form__group">
                                ...
                                <input value="" type="file" name="avatar" id="avatar"
                                    ...
                                    placeholder="Avatar..." />
                                <span class="text-xs text-gray-300"><?php echo e($user->avatar); ?></span>
                            </div>
                            ...
                            <div class="flex flex-col form__group">
                                ...
                                <select name="role" id="role"
                                    class="creat-user__input p-2 mt-1 glassmorphism text-gray-100 outline-none focus:outline-none text-sm rounded-lg">
                                    <option value="1" <?php echo e($user->role == 1 ? 'selected' : ''); ?>>Admin
                                    </option>
                                    <option value="2" <?php echo e($user->role == 2 ? 'selected' : ''); ?>>User
                                    </option>
                                </select>
                                <span class="hidden mt-1 text-xs text-red-500">
...
<?php echo $__env->make('dashboard.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\PHP\WE17315\ASSIGNMENT\app\views/dashboard/user/update.blade.php ENDPATH**/ ?>