...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" dark:class="{ 'overflow-hidden': isSideMenuOpen }">
...
<?php /**PATH E:\xampp\htdocs\PHP\Course\WE17315\ASSIGNMENT\app\views/dashboard/base.blade.php ENDPATH**/ ?>